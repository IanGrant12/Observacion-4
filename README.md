...
- Casos de prueba diseñados en TestRail y generados automáticamente con Test Case Studio.  
- Reportes de bugs y su documentación detallada.  
- Resultados de pruebas Lighthouse con interpretación de métricas.  
- Evidencias de compatibilidad multiplataforma (BrowserStack).  
...
- Registro de errores detectados con su descripción, pasos para reproducir, severidad y evidencia.  
- Evaluación del **rendimiento y accesibilidad** mediante Lighthouse.  
- Pruebas de compatibilidad entre navegadores y dispositivos.  
- Documentación y versionado del trabajo en GitHub.  
...
simulando un entorno real de desarrollo ágil bajo la metodología **SCRUM**.
